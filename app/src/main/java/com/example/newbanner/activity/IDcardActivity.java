...
import com.example.newbanner.client.Demo_数据服务_5_1_身份证识别;
import com.example.newbanner.client.HttpApiClient_数据服务_5_1_身份证识别;
import com.example.newbanner.util.IDUtil;
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_id_ensure:
                if(tvTrueName.getText().equals("")){
                    ...
                    intent.setClass(IDcardActivity.this,DetailActivity.class);
